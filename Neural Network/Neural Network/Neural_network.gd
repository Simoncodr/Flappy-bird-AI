...
# This is for performance, and resizes the arrays to the largest needed size, at ready, to have the game run better
...
func neuralNetwork(input : PackedFloat32Array) -> PackedFloat32Array:
...
func _process(_delta) -> void:
	parent.action(neuralNetwork(parent.gatherData()))
